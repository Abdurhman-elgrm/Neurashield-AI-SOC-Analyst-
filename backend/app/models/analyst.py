...
class InvestigationNote(Base, TimestampMixin, SoftDeleteMixin):
    ...
    __table_args__ = (
        Index("idx_note_tenant_inv", "tenant_id", "investigation_id"),
    )
...
class InvestigationVerdict(Base):
    ...
    __table_args__ = (
        Index("idx_verdict_tenant_inv", "tenant_id", "investigation_id"),
    )
...
class SavedHunt(Base, TimestampMixin):
    ...
    __table_args__ = (
        Index("idx_saved_hunt_tenant_analyst", "tenant_id", "analyst_id"),
    )
